          ...
          child: CarrouselDemoPage(
            memories: [
              MemoryCard(
                ...
                groupName: 'Boda',
                variant: MemoryCardVariant.memory,
                onTap: () {},
                onError: null,
              ),
              MemoryCard(
              ...
              MemoryCard(
                ...
                groupName: 'Amigos',
                variant: MemoryCardVariant.recap,
                onTap: () {},
                onError: null,
              ),
              MemoryCard(
            ...
            builder: (context, setState) {
              return Column(
                ...
                children: [
                  Center(
                    child: SettingsItem(
                      variant: context.knobs.options<SettingsItemVariant>(
                        label: 'Variant',
                        initial: SettingsItemVariant.icon,
                        options: SettingsItemVariant.values
                            .map((item) => Option(label: item.name, value: item))
                            .toList(),
                      ),
                      ...
                      onToggleTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Toggle switched to $isSelected')),
                        );
                      },
                    ),
                  ),
