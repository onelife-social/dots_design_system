...
import '../../core/values/paths/shader_paths.dart';
...
/// pop-in effect. You can do this by calling [DotsLinearGradientBlur.precache] as
/// early as possible in your app (e.g. in `main()`).
class DotsLinearGradientBlur extends StatefulWidget {
  const DotsLinearGradientBlur({
    super.key,
  ...
  const DotsLinearGradientBlur.custom({
    super.key,
  ...
  static Future<void> precache() {
    return ShaderBuilder.precacheShader(ShaderPaths.progressiveBlur);
  }
  ...
  @override
  State<DotsLinearGradientBlur> createState() => _DotsLinearGradientBlurState();
}

class _DotsLinearGradientBlurState extends State<DotsLinearGradientBlur> {
  ...
  @override
  void didUpdateWidget(covariant DotsLinearGradientBlur oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return RepaintBoundary(
      child: ShaderBuilder(
        ...
        assetKey: ShaderPaths.progressiveBlur,
        child: widget.child,
      ),
    );
  }
...
/// Parameters to use to create a blur texture for the [DotsLinearGradientBlur].
///
