...
enum DotsIconData {
  ...
  babyStroller('ic-baby-stroller.svg', DotsIconGroup.album),
  balloons('ic-balloons.svg', DotsIconGroup.album),
  bird('ic-bird.svg', DotsIconGroup.album),
  bookClosed('ic-bookClosed.svg', DotsIconGroup.album),
  ...
  fitness('ic-fitness.svg', DotsIconGroup.album),
  flower('ic-flower.svg', DotsIconGroup.album),
  glitter('ic-glitter.svg', DotsIconGroup.album),
  graduation('ic-graduation.svg', DotsIconGroup.album),
  house('ic-house.svg', DotsIconGroup.album),
  library('ic-library.svg', DotsIconGroup.album),
  lizard('ic-lizard.svg', DotsIconGroup.album),
  medal('ic-medal.svg', DotsIconGroup.album),
  mountains('ic-mountains.svg', DotsIconGroup.album),
  pacifier('ic-pacifier.svg', DotsIconGroup.album),
  pan('ic-pan.svg', DotsIconGroup.album),
  photoFrame('ic-photo-frame.svg', DotsIconGroup.album),
  restaurant('ic-restaurant.svg', DotsIconGroup.album),
  ship('ic-ship.svg', DotsIconGroup.album),
  signpost('ic-signpost.svg', DotsIconGroup.album),
  teddy('ic-teddy.svg', DotsIconGroup.album),
  thunderbolt('ic-thunderbolt.svg', DotsIconGroup.album),
  toast('ic-toast.svg', DotsIconGroup.album),
  twoHeart('ic-two-heart.svg', DotsIconGroup.album),
  ...
  left('ic-arrow-left.svg', DotsIconGroup.arrow),
  ...
  envelope('ic-envelope.svg', DotsIconGroup.media),
  ...
  picAddFill('ic-pic--add-fill.svg', DotsIconGroup.media),
  ...
  picSlashed('ic-pic--slashed.svg', DotsIconGroup.media),
